...
- `packages/kutana-memory/src/kutana_memory/working.py`
- Redis hash per active meeting (`kutana:working:{meeting_id}`)
- Ephemeral -- cleared when meeting ends
- Methods: `store()`, `retrieve()`, `get_all()`, `clear()`

### Short-Term Memory (PostgreSQL)
- `packages/kutana-memory/src/kutana_memory/short_term.py`
...
- `packages/kutana-memory/src/kutana_memory/long_term.py`
...
- `packages/kutana-memory/src/kutana_memory/structured.py`
