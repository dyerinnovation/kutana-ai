...
See [tools.md](tools.md) for the full list and configuration options.
...
Certain features (outcomes, multiagent, and memory) are in research preview. Request access at https://claude.com/form/claude-managed-agents to try them.
