...
from kutana_core.interfaces.tts import TTSProvider
from kutana_core.models.task import Task, TaskPriority
from kutana_core.models.transcript import TranscriptSegment
from kutana_providers.registry import ProviderRegistry, ProviderType, default_registry
from kutana_providers.testing import MockLLM, MockSTT, MockTTS


def _has_groq() -> bool:
    """Check if the groq package is available."""
...
class TestDefaultRegistry:
    ...
    def test_total_provider_counts(self) -> None:
        """Default registry has correct provider counts per category."""
