...
class TestNATSImportGuard:
    ...
    def test_raises_import_error_when_nats_missing(self) -> None:
        ...
        with patch(
            "convene_providers.messaging.nats_jetstream._NATS_AVAILABLE", False
        ):
            from convene_providers.messaging.nats_jetstream import _require_nats
...
class TestNATSSubjectNaming:
    ...
    def test_topic_to_subject_preserves_dots(self) -> None:
        from convene_providers.messaging.nats_jetstream import _topic_to_subject
    ...
    def test_consumer_name_contains_topic_and_group(self) -> None:
        from convene_providers.messaging.nats_jetstream import _consumer_name
