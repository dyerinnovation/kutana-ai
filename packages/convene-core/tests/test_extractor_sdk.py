...
from convene_core.extraction.loader import (
    ENTRY_POINT_GROUP,
    ExtractorLoader,
    ExtractorValidationError,
    validate_extractor,
)
from convene_core.extraction.sdk import (
    SimpleExtractor,
    _FunctionExtractor,
    extractor,
    make_blocker,
...
class TestExtractorLoaderFileLoading:
    ...
    def test_load_from_valid_file(self) -> None:
        ...
        code = textwrap.dedent("""\
            from convene_core.extraction.sdk import SimpleExtractor
...
class TestExtractorLoaderEntryPoints:
    ...
    def test_load_from_entry_points_calls_importlib_metadata(
        ...
        """load_from_entry_points() reads the 'convene.extractors' group."""
        ...
        monkeypatch.setattr(
            "convene_core.extraction.loader.importlib.metadata.entry_points",
            mock_entry_points,
        )
        loader = ExtractorLoader()
