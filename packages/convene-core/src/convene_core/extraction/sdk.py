"""Helper utilities for building custom Convene AI extractors.
...
extractors that plug into the Convene AI extraction pipeline.

Example — decorator style::

    from convene_core.extraction.sdk import extractor, make_task
...
Example — class style::
    ...
    from convene_core.extraction.sdk import SimpleExtractor, make_task
...
class SimpleExtractor(Extractor):
    ...
    async def extract(self, batch: TranscriptBatch) -> ExtractionResult:
        ...
        Returns:
            An :class:`~convene_core.extraction.types.ExtractionResult`.
        """
        return ExtractionResult(
            batch_id=batch.batch_id,
            entities=[],
...
def extractor(
    ...
    :class:`~convene_core.extraction.types.TranscriptBatch` argument and
    return an :class:`~convene_core.extraction.types.ExtractionResult`.
...
def make_task(
    ...
    *,
    ...
    """Create a :class:`~convene_core.extraction.types.TaskEntity`.
...
def make_decision(
    ...
    *,
    ...
    """Create a :class:`~convene_core.extraction.types.DecisionEntity`.
...
def make_question(
    ...
    *,
    ...
    """Create a :class:`~convene_core.extraction.types.QuestionEntity`.
...
def make_key_point(
    ...
    *,
    ...
    """Create a :class:`~convene_core.extraction.types.KeyPointEntity`.
...
def make_blocker(
    ...
    *,
    ...
    """Create a :class:`~convene_core.extraction.types.BlockerEntity`.
...
def make_follow_up(
    ...
    *,
    ...
    """Create a :class:`~convene_core.extraction.types.FollowUpEntity`.
...
def make_entity_mention(
    ...
    *,
    ...
    """Create an :class:`~convene_core.extraction.types.EntityMentionEntity`.
