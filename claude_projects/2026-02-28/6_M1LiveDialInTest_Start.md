...
5. Reads events from Redis Stream `convene:events`
...
| Events | `convene_core/events/definitions.py` | `MeetingStarted`, `MeetingEnded`, `TranscriptSegmentFinal` |
| Redis Stream | key: `convene:events` | max 10,000 entries |
