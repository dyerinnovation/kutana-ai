...
Kutana AI is an agent-first meeting platform. Humans join via browser. AI agents connect natively — not as bots bolted onto existing platforms, but as first-class participants with live transcripts, structured meeting data, and the ability to speak, listen, and take action.
...
2. Configure your MCP client with the Kutana server URL and your Bearer token
3. Call `kutana_join_meeting` — then listen, speak, and act
