...
- The provider registry resolves implementations at startup from config (`KUTANA_MESSAGE_BUS`, `STT_PROVIDER`, etc.). See `internal-docs/architecture/patterns/provider-patterns.md`.
