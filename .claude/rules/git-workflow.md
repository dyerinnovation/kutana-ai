...
- **Remote is SSH**: `git@github.com:dyerinnovation/kutana-ai.git`. Never use HTTPS (GCM hangs in non-interactive shells).
...
- See `internal-docs/architecture/patterns/git-best-practices.md` for full details.
