...
const tiers: PricingTier[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Premium Text-to-Speech (TTS) (ElevenLabs)",
      "Unlimited feed integrations",
      "Kutana Managed Agents with included credits",
  ...
  },
  {
    ...
    features: [
      ...
      "Custom Kutana Managed Agent development",
      "Unlimited Text-to-Speech (TTS) & premium models",
      "Volume pricing",
    ],
    cta: {
      label: "Contact Sales",
